...
```bash
GOAL_PY="$(ls "${CLAUDE_PROJECT_DIR:-.}/.claude/skills/goal/scripts/claude_goal.py" "$HOME/.claude/skills/goal/scripts/claude_goal.py" 2>/dev/null | head -n1)"
python3 "$GOAL_PY" invoke "$ARGUMENTS"
```
